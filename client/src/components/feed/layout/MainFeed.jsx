        ...
        <section className="mt-7 sm:mt-9">
          <div className="flex items-end justify-between gap-3 lg:gap-4">
            ...
            <div className="theme-card inline-flex w-fit shrink-0 rounded-[15px] border border-white/70 bg-white/85 p-1 shadow-[0_8px_18px_rgba(15,23,42,0.045)] ring-1 ring-zinc-200/60 backdrop-blur sm:rounded-[18px] sm:p-1.5 sm:shadow-[0_10px_24px_rgba(15,23,42,0.05)]">
              <button className="theme-toggle-active rounded-[11px] bg-[linear-gradient(135deg,#667eea_0%,#764ba2_100%)] px-4 py-2 text-[12px] font-semibold text-white shadow-[0_8px_18px_rgba(102,126,234,0.22)] sm:rounded-[14px] sm:px-5 sm:py-2.5 sm:text-[13px] sm:shadow-[0_10px_20px_rgba(102,126,234,0.26)]">
                Trending
              </button>
              <button className="theme-toggle-idle rounded-[11px] px-4 py-2 text-[12px] font-semibold text-zinc-500 transition hover:bg-zinc-50 hover:text-zinc-900 sm:rounded-[14px] sm:px-5 sm:py-2.5 sm:text-[13px]">
                Latest
              </button>
            </div>
          </div>
