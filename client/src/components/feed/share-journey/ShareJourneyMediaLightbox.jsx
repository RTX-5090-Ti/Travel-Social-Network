...
export default function ShareJourneyMediaLightbox({ media, onClose }) {
  ...
  return (
    <>
      <motion.div
          className="fixed inset-0 z-[180] bg-[linear-gradient(180deg,rgba(248,245,255,0.58),rgba(236,242,255,0.60))] backdrop-blur-md dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.78),rgba(15,23,42,0.82))]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        onClick={onClose}
          ...
          <div className="flex max-h-[85vh] min-h-[320px] items-center justify-center bg-[radial-gradient(circle_at_top,rgba(182,137,255,0.16),transparent_34%),radial-gradient(circle_at_bottom,rgba(79,124,255,0.10),transparent_38%),linear-gradient(180deg,#fffdfc,#f7f2ff,#eef5ff)] p-3 dark:bg-[radial-gradient(circle_at_top,rgba(139,92,246,0.18),transparent_34%),radial-gradient(circle_at_bottom,rgba(59,130,246,0.12),transparent_38%),linear-gradient(180deg,rgba(2,6,23,0.98),rgba(15,23,42,0.98),rgba(17,24,39,0.98))] sm:p-5">
            {media.kind === "image" ? (
              ...
              <video
                ...
                autoPlay
                playsInline
                className="max-h-[72vh] w-full rounded-[22px] bg-white/70 object-contain dark:bg-white/5"
              />
            )}
          </div>

          <div className="border-t border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.72),rgba(247,242,255,0.76))] px-5 py-4 backdrop-blur-xl dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(15,23,42,0.88),rgba(17,24,39,0.9))] sm:px-6">
