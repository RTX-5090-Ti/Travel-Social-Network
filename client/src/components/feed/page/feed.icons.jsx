...
export function SettingsIcon({ className = "w-5 h-5" }) {
  return (
    ...
    >
      ...
      <path d="M19.4 15a1 1 0 0 0 .2 1.1l.04.04a2 2 0 1 1-2.83 2.83l-.04-.04a1 1 0 0 0-1.1-.2 1 1 0 0 0-.6.91V20a2 2 0 1 1-4 0v-.06a1 1 0 0 0-.6-.91 1 1 0 0 0-1.1.2l-.04.04a2 2 0 1 1-2.83-2.83l.04-.04a1 1 0 0 0 .2-1.1 1 1 0 0 0-.91-.6H4a2 2 0 1 1 0-4h.06a1 1 0 0 0 .91-.6 1 1 0 0 0-.2-1.1l-.04-.04a2 2 0 1 1 2.83-2.83l.04.04a1 1 0 0 0 1.1.2 1 1 0 0 0 .6-.91V4a2 2 0 1 1 4 0v.06a1 1 0 0 0 .6.91 1 1 0 0 0 1.1-.2l.04-.04a2 2 0 1 1 2.83 2.83l-.04.04a1 1 0 0 0-.2 1.1 1 1 0 0 0 .91.6H20a2 2 0 1 1 0 4h-.06a1 1 0 0 0-.54.16Z" />
    </svg>
  );
}
...
export function HeartIcon({ className = "w-5 h-5", filled = false }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="m12 20-1.45-1.32C5.4 14 2 10.9 2 7.1 2 4 4.42 1.75 7.5 1.75c1.74 0 3.41.81 4.5 2.09 1.09-1.28 2.76-2.09 4.5-2.09C19.58 1.75 22 4 22 7.1c0 3.8-3.4 6.9-8.55 11.58L12 20Z" />
    </svg>
  );
}
...
export function ShareIcon({ className = "w-5 h-5" }) {
  return (
    ...
    >
      ...
      <path d="M19 12h-7.2c-3.3 0-5.6 1.5-6.8 5" />
    </svg>
  );
}
...
export function BookmarkFillIcon({ className = "w-5 h-5" }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M7 4.75a1 1 0 0 0-1 1V20l6-3.5 6 3.5V5.75a1 1 0 0 0-1-1H7Z" />
    </svg>
  );
}
...
export function PhotoIcon({ className = "w-5 h-5" }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M5 7a2 2 0 0 1 2-2h2l1.2 1.4a2 2 0 0 0 1.5.6h5.3a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V7Z" />
      <path d="m8 16 3-3 2.5 2.5 2.5-3 2 3.5" />
