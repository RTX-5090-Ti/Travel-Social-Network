...
export default function ProfileMediaLightbox({
  ...
  return createPortal(
    <motion.div
      className="fixed inset-0 z-[200] flex items-center justify-center bg-[linear-gradient(180deg,rgba(248,245,255,0.58),rgba(236,242,255,0.60))] p-3 backdrop-blur-md sm:p-5"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    >
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 border-t border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.72),rgba(247,242,255,0.76))] px-4 pb-3 pt-3 text-zinc-800 backdrop-blur-xl sm:px-5">
          ...
          <div className="inline-flex shrink-0 items-center rounded-full border border-[#e7dcff] bg-[linear-gradient(135deg,rgba(255,255,255,0.95),rgba(245,238,255,0.92))] px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.08em] text-[#7c59d9] shadow-[inset_0_1px_0_rgba(255,255,255,0.85)]">
