      ...
      >
        ...
        <div className="relative z-10 flex items-start justify-between gap-4 px-5 py-4 border-b border-white/60 sm:px-6">
          ...
          <button
            ...
            className="inline-flex h-11 w-11 shrink-0 cursor-pointer items-center justify-center rounded-full border border-white/80 bg-white/82 text-zinc-500 shadow-[0_12px_28px_rgba(15,23,42,0.08)] transition hover:-translate-y-0.5 hover:text-zinc-900 disabled:cursor-not-allowed disabled:opacity-60"
            disabled={isBusy}
          >
            <X className="w-5 h-5" />
          </button>
        ...
        <div className="relative z-10 overflow-hidden">
          ...
          >
            ...
            <div className="flex flex-col w-1/2 px-5 py-5 shrink-0 sm:px-6 sm:py-6">
              <div className="flex flex-col flex-1 space-y-5">
                <div className="rounded-[24px] border border-white/70 bg-white/78 p-4 shadow-[0_14px_30px_rgba(15,23,42,0.05)] ring-1 ring-zinc-200/55 backdrop-blur">
                  ...
                  <div className="mt-4 overflow-hidden rounded-[26px] border border-white/75 bg-[linear-gradient(135deg,rgba(247,249,255,0.96),rgba(241,245,255,0.92),rgba(246,241,255,0.95))] shadow-[0_18px_36px_rgba(91,99,246,0.08)]">
                      ...
                      {currentCoverPreview ? (
                        ...
                        <>
                          ...
                          <div className="absolute inset-0 flex items-center justify-center p-5">
                            <div className="w-full max-w-[380px] rounded-[24px] border border-white/75 bg-white/82 p-5 text-center shadow-[0_16px_36px_rgba(15,23,42,0.08)] backdrop-blur">
                              ...
                              <h5 className="mt-3 text-[16px] font-semibold text-zinc-900">
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-4">
                    ...
                    {hasDraftCover ? (
                      <button
                        ...
                        disabled={isBusy}
                        className="inline-flex cursor-pointer items-center gap-2 rounded-2xl border border-zinc-200 bg-white/85 px-4 py-3 text-[14px] font-semibold text-zinc-500 transition hover:bg-zinc-50 hover:text-zinc-800 disabled:cursor-not-allowed disabled:opacity-60"
                      >
                        Xóa ảnh nháp
                      </button>
                    ) : null}
                ...
                <div className="flex items-center justify-end pt-5 mt-auto border-t border-zinc-200/70">
                  <button
                    type="button"
