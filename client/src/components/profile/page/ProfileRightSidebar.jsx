...
import { suggestions, contacts } from "../../feed/page/feed.constants";
import { SendIcon, UserPlusIcon } from "../../feed/page/feed.icons";
          ...
          <div className="space-y-4">
            {contacts.map((person) => (
              ...
              >
                ...
                <button className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-zinc-100 text-zinc-500 transition hover:bg-zinc-200 hover:text-zinc-700 cursor-pointer">
